  ...
  Widget build(BuildContext context) {
    ...
    Widget tabBar = Column(children: [
      ScrollConfiguration(
        ...
        child: Container(
          // EDITED THIS PART OF THE FILE
          //margin: const EdgeInsetsDirectional.only(top: 4.5),
          padding: const EdgeInsetsDirectional.only(start: 8, top: 4.5),
          color: Color(0xffdcefdc), // TODO contribute to main package so that more theming options
          height: 40,//_kTileHeight,
