...
///
/// Locales: 3
/// Strings: 976 (325 per locale)
///
/// Built on 2025-04-12 at 10:25 UTC
...
import 'strings_tl.g.dart' deferred as l_tl;
import 'strings_tl_QP.g.dart' deferred as l_tl_QP;
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	en(languageCode: 'en'),
	tl(languageCode: 'tl'),
	tlQp(languageCode: 'tl', countryCode: 'QP');
	...
	Future<Translations> build({
		...
		switch (this) {
			...
			case AppLocale.tl:
				...
				return l_tl.TranslationsTl(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			case AppLocale.tlQp:
				await l_tl_QP.loadLibrary();
				return l_tl_QP.TranslationsTlQp(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
